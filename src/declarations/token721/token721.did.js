export const idlFactory = ({ IDL }) => {
  ...
  const AttributeData = IDL.Record({
    'name' : IDL.Text,
    'slot' : IDL.Text,
  ...
  return IDL.Service({
    ...
    'data_of' : IDL.Func([IDL.Nat64], [IDL.Vec(AttributeData)], ['query']),
    'data_of_many' : IDL.Func(
        [DataOfQuery],
        [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Vec(AttributeData)))],
        ['query'],
      ),
