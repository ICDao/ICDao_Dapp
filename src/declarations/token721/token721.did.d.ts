...
export type ClaimResult = { 'Ok' : bigint } |
  { 'Err' : string };
export type DataOfQuery = { 'List' : Array<bigint> } |
  { 'Range' : [bigint, bigint] };
...
export interface _SERVICE {
  ...
  'data_of' : (arg_0: bigint) => Promise<Array<AttributeData>>,
  'data_of_many' : (arg_0: DataOfQuery) => Promise<
      Array<[bigint, Array<AttributeData>]>
    >,
  ...
  'get_token_properties_range' : (arg_0: bigint, arg_1: bigint) => Promise<
  ...
  'transfer_with_notify' : (arg_0: Principal, arg_1: bigint) => Promise<
      boolean
    >,
