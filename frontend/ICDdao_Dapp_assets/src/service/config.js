...
export const config = {
	...
	LOCAL_IDENTITY_URL: `http://localhost:8000?canisterId=ryjl3-tyaaa-aaaaa-aaaba-cai`,
	LOCAL_BACKEND_URL: `http://localhost:8000/PATH?canisterId=ryjl3-tyaaa-aaaaa-aaaba-cai`,
